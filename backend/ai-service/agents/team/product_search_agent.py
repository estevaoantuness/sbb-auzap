"""product_search_agent — especialista em consulta de preço/estoque/promoção."""
...
from prompts.specialists.product_search import build_product_search_prompt
...
def build_product_search_agent(context: dict, router_ctx: dict) -> Agent:
    ...
    return Agent(
        ...
        instructions=append_global_agent_max_rules(
            build_product_search_prompt(context, router_ctx)
        ),
        tools=tools,
        tool_call_limit=4,
    )
